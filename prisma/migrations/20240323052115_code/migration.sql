/*
  ...
  - Added the required column `codeKuliah` to the `PengajuanMagang` table without a default value. This is not possible if the table is not empty.
